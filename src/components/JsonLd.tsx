      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description: "High-pressure abrasive blasting for PEB steel, rust removal, mill scale elimination, and surface profiling all over Tamil Nadu & South India.",
            areaServed: "All Over Tamil Nadu, Chennai, Coimbatore, Salem, Hosur, Trichy, Madurai, Vellore, Ranipet, South India",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Twin-wire thermal arc spray metallizing offering 25+ years cathodic rust prevention for heavy industrial structural steel all over Tamil Nadu.",
            areaServed: "All Over Tamil Nadu, South India",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Precision high-build epoxy, zinc-rich primer, and polyurethane topcoat application with verified dry film thickness (DFT) all over Tamil Nadu.",
            areaServed: "All Over Tamil Nadu, South India",
          },
        },
        {
          ...
          itemOffered: {
            ...
            description: "Non-destructive low-pressure blasting for ancient granite temple carvings, mantapams, and heritage structures across all districts of Tamil Nadu.",
            areaServed: "All Over Tamil Nadu, South India",
          },
        },
      ],
