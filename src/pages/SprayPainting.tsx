...
export default function SprayPainting() {
  return (
    <>
      <Seo
        title="Industrial Spray Painting in Vellore | GK Coatings"
      ...
      <article className="bg-offwhite py-16 text-graphite md:py-24">
        <div className="container-site max-w-4xl">
          ...
          <p className="mt-4 leading-relaxed text-ink/75">
            ...
            film build and appearance depend on the coatings system, application conditions and the quality of
          ...
          <p className="mt-4 leading-relaxed text-ink/75">
            ...
            metal surfaces that have been prepared for coatings.
          </p>
          <h2 className="mt-10 text-3xl font-extrabold">Surface preparation</h2>
          <p className="mt-4 leading-relaxed text-ink/75">
            Painting is treated as a later stage. GK Coatings&apos; approach is to prepare first — removing
          ...
          <ol className="mt-4 space-y-3 text-ink/80">
            <li>01 — Review the surface and specified coatings.</li>
            <li>02 — Prepare the surface as required for the project.</li>
            <li>03 — Apply spray coatings under suitable site conditions.</li>
