...
export default function Process() {
  return (
    <>
      <Seo
        title="Our Process | Surface Preparation Workflow | GK Coatings"
        description="Inspect, prepare, blast and finish — GK Coatings’ clear path from surface condition to coatings-ready steel and stone."
        path="/process"
      />
      <PageHero
        kicker="Process"
        title="From surface condition to finished preparation"
        body="A restrained, repeatable sequence that keeps coatings work grounded in the condition of the substrate."
        image={images.mill}
      />
      ...
      <section className="bg-mist py-16 text-graphite md:py-24">
        <div className="container-site">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-4">
            {["Old / contaminated surface", "Blasting / preparation", "Clean surface", "Protective coatings"].map(
              (item, i) => (
